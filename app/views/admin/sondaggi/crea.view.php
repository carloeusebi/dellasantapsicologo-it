            ...
            <div class="drag-container">
                ...
                <?php else : ?>
                    ...
                    <?php foreach ($questions as $question) : ?>
                        ...
                        <div class="d-flex align-items-center user-select-none draggable justify-content-between justify-content-lg-start add-survey-question border px-3" draggable="true">
